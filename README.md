...
- 🌱 Deepening my knowledge in **Statistical Modeling** and **Machine Learning**
- 🤝 Exploring opportunities in **Data Analytics**, **Data Science**, and **GenAI**
- 📊 Creating interactive dashboards and visualizations
- 💡 Contributing to open-source data science projects

## 📈 Featured Projects

### 🛡️ [SafeSpace: Digital Behaviour Monitor](https://github.com/VaishnavThorwat/SafeSpace__Digital_Behaviour_Monitor)
...
- 📌 **Key Skills:** Deep Learning, NLP, TensorFlow/Keras, CNN-BiLSTM, Text Classification
- 🎯 **Impact:** Achieved 91.02% validation accuracy with 91.05% F1-Score, effectively detecting harmful content while minimizing false positives

### 🏠 [Surprise Housing Price Prediction](https://github.com/VaishnavThorwat/Surprise_Housing_Case_Study)
...
- 💼 [LinkedIn](https://www.linkedin.com/in/vaishnav-thorwat)
...
⭐️ From [VaishnavThorwat](https://github.com/VaishnavThorwat)
